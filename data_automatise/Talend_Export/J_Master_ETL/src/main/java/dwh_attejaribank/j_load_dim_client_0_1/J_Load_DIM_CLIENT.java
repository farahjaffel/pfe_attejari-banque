...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.service_sms_banking = readInteger(dis,ois);
					
						this.acces_banque_en_ligne = readString(dis,ois);
					
						this.alerte_securite_active = readInteger(dis,ois);
					
						this.e_releve_active = readInteger(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.service_sms_banking = readInteger(dis,objectIn);
					
						this.acces_banque_en_ligne = readString(dis,objectIn);
					
						this.alerte_securite_active = readInteger(dis,objectIn);
					
						this.e_releve_active = readInteger(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.service_sms_banking, dos, oos);
					
						writeString(this.acces_banque_en_ligne, dos, oos);
					
					writeInteger(this.alerte_securite_active, dos, oos);
					
					writeInteger(this.e_releve_active, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.service_sms_banking, dos, objectOut);
					
						writeString(this.acces_banque_en_ligne, dos, objectOut);
					
					writeInteger(this.alerte_securite_active, dos, objectOut);
					
					writeInteger(this.e_releve_active, dos, objectOut);
...
+"OM \"DWH_ATTEJARI\".\"DIM_DIGITAL\"";
            ...
            row2.service_sms_banking = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    row2.service_sms_banking = null;
            }
		                    }
            ...
            row2.alerte_securite_active = rs_tDBInput_2.getInt(5);
            if(rs_tDBInput_2.wasNull()){
                    row2.alerte_securite_active = null;
            }
		                    }
            ...
            row2.e_releve_active = rs_tDBInput_2.getInt(6);
            if(rs_tDBInput_2.wasNull()){
                    row2.e_releve_active = null;
            }
		                    }
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
    ...
    public String loopKey;
			    ...
			    public Integer id_type_convention_sk;

				public Integer getId_type_convention_sk () {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.id_type_convention_sk = readInteger(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.id_type_convention_sk = readInteger(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.id_type_convention_sk, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.id_type_convention_sk, dos, objectOut);
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = context.password; 
		    ...
		    String dbquery_tDBInput_3 = "SELECT \n  \"DWH_ATTEJARI\".\"DIM_FINANCIER\".\"id_financier_sk\", \n  \"DWH_ATTEJARI\".\"DIM_FINANCIER\".\"id_client\", "
+"\n  \"DWH_ATTEJARI\".\"DIM_FINANCIER\".\"frais_bancaires_mensuels\", \n  \"DWH_ATTEJARI\".\"DIM_FINANCIER\".\"total_frais_"
+"cumules\", \n  \"DWH_ATTEJARI\".\"DIM_FINANCIER\".\"revenu_mensuel\", \n  \"DWH_ATTEJARI\".\"DIM_FINANCIER\".\"methode_pai"
+"ement_fav\", \n  \"DWH_ATTEJARI\".\"DIM_FINANCIER\".\"id_type_convention_sk\"\nFROM \"DWH_ATTEJARI\".\"DIM_FINANCIER\"";
            ...
            row3.frais_bancaires_mensuels = rs_tDBInput_3.getDouble(3);
            if(rs_tDBInput_3.wasNull()){
                    row3.frais_bancaires_mensuels = null;
            }
		                    }
            ...
            row3.total_frais_cumules = rs_tDBInput_3.getDouble(4);
            if(rs_tDBInput_3.wasNull()){
                    row3.total_frais_cumules = null;
            }
		                    }
            ...
            row3.revenu_mensuel = rs_tDBInput_3.getDouble(5);
            if(rs_tDBInput_3.wasNull()){
                    row3.revenu_mensuel = null;
            }
		                    }
        	...
        	row3.methode_paiement_fav = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 7) {
								row3.id_type_convention_sk = null;
							} else {
		                          
            row3.id_type_convention_sk = rs_tDBInput_3.getInt(7);
            if(rs_tDBInput_3.wasNull()){
                    row3.id_type_convention_sk = null;
            }
		                    }
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.nb_produits_actifs = readInteger(dis,ois);
					
						this.conseiller_dedie = readInteger(dis,ois);
					
						this.programme_fidelite = readInteger(dis,ois);
					
						this.assurance_moyen_paiement = readInteger(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.nb_produits_actifs = readInteger(dis,objectIn);
					
						this.conseiller_dedie = readInteger(dis,objectIn);
					
						this.programme_fidelite = readInteger(dis,objectIn);
					
						this.assurance_moyen_paiement = readInteger(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.nb_produits_actifs, dos, oos);
					
					writeInteger(this.conseiller_dedie, dos, oos);
					
					writeInteger(this.programme_fidelite, dos, oos);
					
					writeInteger(this.assurance_moyen_paiement, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.nb_produits_actifs, dos, objectOut);
					
					writeInteger(this.conseiller_dedie, dos, objectOut);
					
					writeInteger(this.programme_fidelite, dos, objectOut);
					
					writeInteger(this.assurance_moyen_paiement, dos, objectOut);
...
+"M \"DWH_ATTEJARI\".\"DIM_PRODUIT\"";
            ...
            row4.nb_produits_actifs = rs_tDBInput_4.getInt(3);
            if(rs_tDBInput_4.wasNull()){
                    row4.nb_produits_actifs = null;
            }
		                    }
            ...
            row4.conseiller_dedie = rs_tDBInput_4.getInt(4);
            if(rs_tDBInput_4.wasNull()){
                    row4.conseiller_dedie = null;
            }
		                    }
            ...
            row4.programme_fidelite = rs_tDBInput_4.getInt(5);
            if(rs_tDBInput_4.wasNull()){
                    row4.programme_fidelite = null;
            }
		                    }
            ...
            row4.assurance_moyen_paiement = rs_tDBInput_4.getInt(6);
            if(rs_tDBInput_4.wasNull()){
                    row4.assurance_moyen_paiement = null;
            }
		                    }
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.enfants_a_charge = readInteger(dis,ois);
					
						this.profession = readString(dis,ois);
					
						this.ville_region = readString(dis,ois);
					
						this.est_senior = readInteger(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.enfants_a_charge = readInteger(dis,objectIn);
					
						this.profession = readString(dis,objectIn);
					
						this.ville_region = readString(dis,objectIn);
					
						this.est_senior = readInteger(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.enfants_a_charge, dos, oos);
					
						writeString(this.profession, dos, oos);
					
						writeString(this.ville_region, dos, oos);
					
					writeInteger(this.est_senior, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.enfants_a_charge, dos, objectOut);
					
						writeString(this.profession, dos, objectOut);
					
						writeString(this.ville_region, dos, objectOut);
					
					writeInteger(this.est_senior, dos, objectOut);
...
+"_PROFIL\".\"est_senior\"\nFROM \"DWH_ATTEJARI\".\"DIM_PROFIL\"";
            ...
            row5.enfants_a_charge = rs_tDBInput_5.getInt(4);
            if(rs_tDBInput_5.wasNull()){
                    row5.enfants_a_charge = null;
            }
		                    }
            ...
            row5.est_senior = rs_tDBInput_5.getInt(7);
            if(rs_tDBInput_5.wasNull()){
                    row5.est_senior = null;
            }
		                    }
...
/************************************************************************************************
 *     236496 characters generated by Talend Open Studio for Data Integration 
