...
int count_tDBOutput_1=0;
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_dim_tx_sk\" SERIAL ,\"id_transaction\" VARCHAR(13)   not null ,\"id_client\" VARCHAR(10)   not null ,\"id_canal_tx_fk\" SERIAL ,\"id_sens_oper_tx_fk\" INT4 ,\"id_operation_tx_fk\" INT4 ,\"date_transaction\" DATE  not null ,\"montant\" FLOAT8  not null ,\"est_rejete\" INT8 ,\"solde_apres_operation\" FLOAT8 ,primary key(\"id_transaction\"))");
                                    }
                                }
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"id_transaction\" = ?,\"id_client\" = ?,\"id_canal_tx_fk\" = ?,\"id_sens_oper_tx_fk\" = ?,\"id_operation_tx_fk\" = ?,\"date_transaction\" = ?,\"montant\" = ?,\"est_rejete\" = ?,\"solde_apres_operation\" = ? WHERE \"id_transaction\" = ?";
...
} else {pstmtUpdate_tDBOutput_1.setString(1, tx.id_transaction);
}

                    if(tx.id_client == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, tx.id_client);
}

                    if(tx.id_canal_tx_fk == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(3, tx.id_canal_tx_fk);
}

                    if(tx.id_sens_oper_tx_fk == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(4, tx.id_sens_oper_tx_fk);
}

                    if(tx.id_operation_tx_fk == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(5, tx.id_operation_tx_fk);
}

                    if(tx.date_transaction != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(tx.date_transaction.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.TIMESTAMP);
}

                    pstmtUpdate_tDBOutput_1.setDouble(7, tx.montant);

                    if(tx.est_rejete == null) {
pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setLong(8, tx.est_rejete);
}

                    if(tx.solde_apres_operation == null) {
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_1.setDouble(9, tx.solde_apres_operation);
}


                    if(tx.id_transaction == null) {
pstmtUpdate_tDBOutput_1.setNull(10 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(10 + count_tDBOutput_1, tx.id_transaction);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, tx.id_transaction);
}

                        if(tx.id_client == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, tx.id_client);
}

                        if(tx.id_canal_tx_fk == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(3, tx.id_canal_tx_fk);
}

                        if(tx.id_sens_oper_tx_fk == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(4, tx.id_sens_oper_tx_fk);
}

                        if(tx.id_operation_tx_fk == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(5, tx.id_operation_tx_fk);
}

                        if(tx.date_transaction != null) {
pstmtInsert_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(tx.date_transaction.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.TIMESTAMP);
}

                        pstmtInsert_tDBOutput_1.setDouble(7, tx.montant);

                        if(tx.est_rejete == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setLong(8, tx.est_rejete);
}

                        if(tx.solde_apres_operation == null) {
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_1.setDouble(9, tx.solde_apres_operation);
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2,row4,row3) outputs:(tx)
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    ...
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_load_DIM_TRANSACTION = new byte[0];
			    ...
			    public int id_operation_tx_sk;

				public int getId_operation_tx_sk () {
		...
		synchronized(commonByteArrayLock_DWH_ATTEJARIBANK_J_load_DIM_TRANSACTION) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.id_operation_tx_sk = dis.readInt();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.id_operation_tx_sk);
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = context.password; 
		    ...
		    String dbquery_tDBInput_3 = "SELECT \n  \""+context.schema+"\".\"DIM_OPERATION_TX\".\"id_operation_tx_sk\",\n  \""+context.schema+"\".\"DIM_OPERATION_TX\".\"type_operation\", \n  \""+context.schema+"\".\"DIM_OPERATION_TX\".\"categorie_depense\"\nFROM \""+context.schema+"\".\"DIM_OPERATION_TX\"";
...
/************************************************************************************************
 *     160500 characters generated by Talend Open Studio for Data Integration 
