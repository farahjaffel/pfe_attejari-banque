...
package dwh_attejaribank.j_load8dim_digital_0_1;
...
/**
 * Job: J_Load8DIM_DIGITAL Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class J_Load8DIM_DIGITAL implements TalendJob {
...
public String getSchema_staging(){
	...
	private final String jobName = "J_Load8DIM_DIGITAL";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				J_Load8DIM_DIGITAL.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(J_Load8DIM_DIGITAL.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class digitalStruct implements routines.system.IPersistableRow<digitalStruct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL = new byte[0];
    ...
    public String loopKey;
			    ...
			    public Integer id_digital_sk;

				public Integer getId_digital_sk () {
	...
	public boolean equals(Object obj) {
		...
		final digitalStruct other = (digitalStruct) obj;
	...
	public void copyDataTo(digitalStruct other) {
	...
	public void copyKeysDataTo(digitalStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL.length) {
				if(length < 1024 && commonByteArray_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL.length == 0) {
   					commonByteArray_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL = new byte[1024];
				} else {
   					commonByteArray_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DWH_ATTEJARIBANK_J_Load8DIM_DIGITAL) {

        	try {

        		int length = 0;
		
						this.id_digital_sk = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.id_digital_sk,dos);
     ...
     * Compare keys
     */
    public int compareTo(digitalStruct other) {
...
digitalStruct digital = new digitalStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"digital");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DIM_DIGITAL");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DIM_DIGITAL");
}
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("DIM_DIGITAL"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_digital_sk\" SERIAL ,\"id_client\" VARCHAR(10)   not null ,\"service_sms_banking\" INT8 ,\"acces_banque_en_ligne\" VARCHAR(8)  ,\"alerte_securite_active\" INT8 ,\"e_releve_active\" INT8 ,primary key(\"id_client\"))");
                                    }
                                }
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"id_client\" = ?,\"service_sms_banking\" = ?,\"acces_banque_en_ligne\" = ?,\"alerte_securite_active\" = ?,\"e_releve_active\" = ? WHERE \"id_client\" = ?";
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_client\",\"service_sms_banking\",\"acces_banque_en_ligne\",\"alerte_securite_active\",\"e_releve_active\") VALUES (?,?,?,?,?)";
...
digitalStruct digital_tmp = new digitalStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.password; 
            ...
            row1.frais_bancaires_mensuels = rs_tDBInput_1.getBigDecimal(19);
            if(rs_tDBInput_1.wasNull()){
                    row1.frais_bancaires_mensuels = null;
            }
		                    }
            ...
            row1.total_frais_cumules = rs_tDBInput_1.getBigDecimal(20);
            if(rs_tDBInput_1.wasNull()){
                    row1.total_frais_cumules = null;
            }
		                    }
            ...
            row1.revenu_mensuel = rs_tDBInput_1.getBigDecimal(21);
            if(rs_tDBInput_1.wasNull()){
                    row1.revenu_mensuel = null;
            }
		                    }
            ...
            row1.score_risque_interne = rs_tDBInput_1.getBigDecimal(23);
            if(rs_tDBInput_1.wasNull()){
                    row1.score_risque_interne = null;
            }
		                    }
...
// # Output table : 'digital'
digital_tmp.id_digital_sk = null;
digital_tmp.id_client = row1.id_client ;
digital_tmp.service_sms_banking = row1.service_sms_banking ;
digital_tmp.acces_banque_en_ligne = row1.acces_banque_en_ligne ;
digital_tmp.alerte_securite_active = row1.alerte_securite_active ;
digital_tmp.e_releve_active = row1.e_releve_active ;
digital = digital_tmp;
// ###############################
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
            int updateFlag_tDBOutput_1=0;
                    if(digital.id_client == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, digital.id_client);
}

                    if(digital.service_sms_banking == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setLong(2, digital.service_sms_banking);
}

                    if(digital.acces_banque_en_ligne == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, digital.acces_banque_en_ligne);
}

                    if(digital.alerte_securite_active == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setLong(4, digital.alerte_securite_active);
}

                    if(digital.e_releve_active == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setLong(5, digital.e_releve_active);
}


                    if(digital.id_client == null) {
pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1, digital.id_client);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, digital.id_client);
}

                        if(digital.service_sms_banking == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setLong(2, digital.service_sms_banking);
}

                        if(digital.acces_banque_en_ligne == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, digital.acces_banque_en_ligne);
}

                        if(digital.alerte_securite_active == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setLong(4, digital.alerte_securite_active);
}

                        if(digital.e_releve_active == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setLong(5, digital.e_releve_active);
}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"digital");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final J_Load8DIM_DIGITAL J_Load8DIM_DIGITALClass = new J_Load8DIM_DIGITAL();

        int exitCode = J_Load8DIM_DIGITALClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = J_Load8DIM_DIGITAL.class.getClassLoader().getResourceAsStream("dwh_attejaribank/j_load8dim_digital_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = J_Load8DIM_DIGITAL.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : J_Load8DIM_DIGITAL");
        }
...
/************************************************************************************************
 *     93650 characters generated by Talend Open Studio for Data Integration 
 *     on the 16 avril 2026 à 15:48:57 WAT
 ************************************************************************************************/