...
package dwh_attejaribank.j_load_operation_0_1;
...
/**
 * Job: J_Load_OPERATION Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class J_Load_OPERATION implements TalendJob {
...
public String getSchema_staging(){
	...
	private final String jobName = "J_Load_OPERATION";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				J_Load_OPERATION.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(J_Load_OPERATION.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_OPERATION = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load_OPERATION = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DWH_ATTEJARIBANK_J_Load_OPERATION.length) {
				if(length < 1024 && commonByteArray_DWH_ATTEJARIBANK_J_Load_OPERATION.length == 0) {
   					commonByteArray_DWH_ATTEJARIBANK_J_Load_OPERATION = new byte[1024];
				} else {
   					commonByteArray_DWH_ATTEJARIBANK_J_Load_OPERATION = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DWH_ATTEJARIBANK_J_Load_OPERATION, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_J_Load_OPERATION, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DWH_ATTEJARIBANK_J_Load_OPERATION, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_J_Load_OPERATION, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_OPERATION) {
...
public static class SENSStruct implements routines.system.IPersistableRow<SENSStruct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_OPERATION = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load_OPERATION = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final SENSStruct other = (SENSStruct) obj;
	...
	public void copyDataTo(SENSStruct other) {
	...
	public void copyKeysDataTo(SENSStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(SENSStruct other) {
...
SENSStruct SENS = new SENSStruct();
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DIM_SensOper_TX");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DIM_SensOper_TX");
}
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("DIM_SensOper_TX"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_sensOper_tx_sk\" SERIAL  not null ,\"sens_operation\" VARCHAR(6)  ,primary key(\"sens_operation\"))");
                                    }
                                }
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"sens_operation\" = ? WHERE \"sens_operation\" = ?";
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"sens_operation\") VALUES (?)";
 ...
 */
	...
	currentComponent="tUniqRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"SENS");
					}
...
SENSStruct SENS_tmp = new SENSStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.password; 
            ...
            row1.montant = rs_tDBInput_1.getBigDecimal(5);
            ...
            row1.solde_apres_operation = rs_tDBInput_1.getBigDecimal(8);
            if(rs_tDBInput_1.wasNull()){
                    row1.solde_apres_operation = null;
            }
		                    }
...
// # Output table : 'SENS'
SENS_tmp.id_sensOper_tx_sk = 0;
SENS_tmp.sens_operation = row1.sens_operation ;
SENS = SENS_tmp;
// ###############################
...
row2 = null;			
if(SENS.sens_operation == null){
	finder_tUniqRow_1.sens_operation = null;
}else{
	finder_tUniqRow_1.sens_operation = SENS.sens_operation.toLowerCase();
}	
...
if(SENS.sens_operation == null){
	new_tUniqRow_1.sens_operation = null;
}else{
	new_tUniqRow_1.sens_operation = SENS.sens_operation.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.id_sensOper_tx_sk = SENS.id_sensOper_tx_sk;			row2.sens_operation = SENS.sens_operation;					
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
            int updateFlag_tDBOutput_1=0;
                    if(row2.sens_operation == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, row2.sens_operation);
}


                    if(row2.sens_operation == null) {
pstmtUpdate_tDBOutput_1.setNull(2 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2 + count_tDBOutput_1, row2.sens_operation);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, row2.sens_operation);
}
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"SENS");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final J_Load_OPERATION J_Load_OPERATIONClass = new J_Load_OPERATION();

        int exitCode = J_Load_OPERATIONClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = J_Load_OPERATION.class.getClassLoader().getResourceAsStream("dwh_attejaribank/j_load_operation_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = J_Load_OPERATION.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : J_Load_OPERATION");
        }
...
/************************************************************************************************
 *     83159 characters generated by Talend Open Studio for Data Integration 
 *     on the 16 avril 2026 à 15:49:08 WAT
 ************************************************************************************************/