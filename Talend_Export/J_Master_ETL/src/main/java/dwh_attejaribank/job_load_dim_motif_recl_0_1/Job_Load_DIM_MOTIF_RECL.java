...
package dwh_attejaribank.job_load_dim_motif_recl_0_1;
...
/**
 * Job: Job_Load_DIM_MOTIF_RECL Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Job_Load_DIM_MOTIF_RECL implements TalendJob {
...
public String getSchema_staging(){
	...
	private final String jobName = "Job_Load_DIM_MOTIF_RECL";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Job_Load_DIM_MOTIF_RECL.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Job_Load_DIM_MOTIF_RECL.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL = new byte[0];
    ...
    public String loopKey;
			    ...
			    public Integer id_motif_recla_sk;

				public Integer getId_motif_recla_sk () {
					return this.id_motif_recla_sk;
				}
	...
	public void copyDataTo(row3Struct other) {
		...
		other.id_motif_recla_sk = this.id_motif_recla_sk;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL.length) {
				if(length < 1024 && commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL.length == 0) {
   					commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL = new byte[1024];
				} else {
   					commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL) {

        	try {

        		int length = 0;
		
						this.id_motif_recla_sk = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.id_motif_recla_sk,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("id_motif_recla_sk="+String.valueOf(id_motif_recla_sk));
...
public static class motifStruct implements routines.system.IPersistableRow<motifStruct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_MOTIF_RECL = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final motifStruct other = (motifStruct) obj;
	...
	public void copyDataTo(motifStruct other) {
	...
	public void copyKeysDataTo(motifStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(motifStruct other) {
...
motifStruct motif = new motifStruct();
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DIM_MOTIF_RECLAMATION");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DIM_MOTIF_RECLAMATION");
}
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("DIM_MOTIF_RECLAMATION"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_motif_recla_sk\" SERIAL  not null ,\"motif_reclamation\" VARCHAR(15)  ,primary key(\"motif_reclamation\"))");
                                    }
                                }
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"motif_reclamation\" = ? WHERE \"motif_reclamation\" = ?";
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"motif_reclamation\") VALUES (?)";
 ...
 */
	...
	currentComponent="tUniqRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"motif");
					}
...
motifStruct motif_tmp = new motifStruct();
// ###############################
...
// # Output table : 'motif'
motif_tmp.id_motif_recla_sk = null;
motif_tmp.motif_reclamation = row1.motif_reclamation == null || row1.motif_reclamation.trim().equals("") 
? "Pas de probleme" 
: row1.motif_reclamation ;
motif = motif_tmp;
// ###############################
...
row2 = null;			
if(motif.motif_reclamation == null){
	finder_tUniqRow_1.motif_reclamation = null;
}else{
	finder_tUniqRow_1.motif_reclamation = motif.motif_reclamation.toLowerCase();
}	
...
if(motif.motif_reclamation == null){
	new_tUniqRow_1.motif_reclamation = null;
}else{
	new_tUniqRow_1.motif_reclamation = motif.motif_reclamation.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.id_motif_recla_sk = motif.id_motif_recla_sk;			row2.motif_reclamation = motif.motif_reclamation;					
...
///////////////////////		
	    		...
	    		if(row2.id_motif_recla_sk != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(row2.id_motif_recla_sk)							
				);
	    		...
	    		if(row2.motif_reclamation != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(row2.motif_reclamation)							
				);
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
            int updateFlag_tDBOutput_1=0;
                    if(row3.motif_reclamation == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, row3.motif_reclamation);
}


                    if(row3.motif_reclamation == null) {
pstmtUpdate_tDBOutput_1.setNull(2 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2 + count_tDBOutput_1, row3.motif_reclamation);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, row3.motif_reclamation);
}
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"motif");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Job_Load_DIM_MOTIF_RECL Job_Load_DIM_MOTIF_RECLClass = new Job_Load_DIM_MOTIF_RECL();

        int exitCode = Job_Load_DIM_MOTIF_RECLClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Job_Load_DIM_MOTIF_RECL.class.getClassLoader().getResourceAsStream("dwh_attejaribank/job_load_dim_motif_recl_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Job_Load_DIM_MOTIF_RECL.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Job_Load_DIM_MOTIF_RECL");
        }
...
/************************************************************************************************
 *     99261 characters generated by Talend Open Studio for Data Integration 
