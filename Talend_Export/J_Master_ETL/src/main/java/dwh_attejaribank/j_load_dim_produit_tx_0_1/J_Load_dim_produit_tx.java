...
package dwh_attejaribank.j_load_dim_produit_tx_0_1;
...
/**
 * Job: J_Load_dim_produit_tx Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class J_Load_dim_produit_tx implements TalendJob {
...
public String getSchema_staging(){
	...
	private final String jobName = "J_Load_dim_produit_tx";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				J_Load_dim_produit_tx.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(J_Load_dim_produit_tx.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_dim_produit_tx = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx.length) {
				if(length < 1024 && commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx.length == 0) {
   					commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx = new byte[1024];
				} else {
   					commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_dim_produit_tx) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.categorie_depense = readString(dis);
						...
						this.id_operation_tx_sk = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.id_operation_tx_sk,dos);
...
public static class operationStruct implements routines.system.IPersistableRow<operationStruct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_dim_produit_tx = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final operationStruct other = (operationStruct) obj;
	...
	public void copyDataTo(operationStruct other) {
	...
	public void copyKeysDataTo(operationStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(operationStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load_dim_produit_tx = new byte[0];
			    ...
			    public BigDecimal solde_apres_operation;

				public BigDecimal getSolde_apres_operation () {
					return this.solde_apres_operation;
				}
				
			    public Integer est_rejete;

				public Integer getEst_rejete () {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.canal_transaction = readString(dis);
						...
						this.solde_apres_operation = (BigDecimal) dis.readObject();
					
						this.est_rejete = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.solde_apres_operation);
					
					// Integer
				
						writeInteger(this.est_rejete,dos);
...
operationStruct operation = new operationStruct();
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DIM_OPERATION_TX");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DIM_OPERATION_TX");
}
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("DIM_OPERATION_TX"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"type_operation\" VARCHAR(14)  ,\"categorie_depense\" VARCHAR(13)  ,\"id_operation_tx_sk\" INT4 ,primary key(\"type_operation\",\"categorie_depense\"))");
                                    }
                                }
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"type_operation\" = ?,\"categorie_depense\" = ? WHERE \"type_operation\" = ? AND \"categorie_depense\" = ?";
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"type_operation\",\"categorie_depense\") VALUES (?,?)";
 ...
 */
	...
	currentComponent="tUniqRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"operation");
					}
...
operationStruct operation_tmp = new operationStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.password; 
        	...
        	row1.id_transaction = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row1.id_client = null;
							} else {
	                         		
        	row1.id_client = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row1.date_transaction = null;
							} else {
										
			row1.date_transaction = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 3);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row1.type_operation = null;
							} else {
	                         		
        	row1.type_operation = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row1.montant = null;
							} else {
		                          
            row1.montant = rs_tDBInput_2.getBigDecimal(5);
        	...
        	row1.sens_operation = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 7) {
								row1.canal_transaction = null;
							} else {
	                         		
        	row1.canal_transaction = routines.system.JDBCUtil.getString(rs_tDBInput_2, 7, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 8) {
								row1.solde_apres_operation = null;
							} else {
		                          
            row1.solde_apres_operation = rs_tDBInput_2.getBigDecimal(8);
            if(rs_tDBInput_2.wasNull()){
                    row1.solde_apres_operation = null;
            }
		                    }
            ...
            row1.est_rejete = rs_tDBInput_2.getInt(9);
            if(rs_tDBInput_2.wasNull()){
                    row1.est_rejete = null;
            }
		                    }
        	...
        	row1.categorie_depense = routines.system.JDBCUtil.getString(rs_tDBInput_2, 10, false);
		                    }
...
operation_tmp.type_operation = row1.type_operation ;
operation_tmp.categorie_depense = row1.categorie_depense == null || "".equals(row1.categorie_depense.trim()) ? "N/A" : row1.categorie_depense ;
operation_tmp.id_operation_tx_sk = null;
...
row2 = null;			
if(operation.type_operation == null){
	finder_tUniqRow_1.type_operation = null;
}else{
	finder_tUniqRow_1.type_operation = operation.type_operation.toLowerCase();
}
if(operation.categorie_depense == null){
	finder_tUniqRow_1.categorie_depense = null;
}else{
	finder_tUniqRow_1.categorie_depense = operation.categorie_depense.toLowerCase();
}	
...
if(operation.type_operation == null){
	new_tUniqRow_1.type_operation = null;
}else{
	new_tUniqRow_1.type_operation = operation.type_operation.toLowerCase();
}
if(operation.categorie_depense == null){
	new_tUniqRow_1.categorie_depense = null;
}else{
	new_tUniqRow_1.categorie_depense = operation.categorie_depense.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.type_operation = operation.type_operation;			row2.categorie_depense = operation.categorie_depense;			row2.id_operation_tx_sk = operation.id_operation_tx_sk;					
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
            int updateFlag_tDBOutput_1=0;
                    if(row2.type_operation == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, row2.type_operation);
}

                    if(row2.categorie_depense == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, row2.categorie_depense);
}


                    if(row2.type_operation == null) {
pstmtUpdate_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, row2.type_operation);
}


                    if(row2.categorie_depense == null) {
pstmtUpdate_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4 + count_tDBOutput_1, row2.categorie_depense);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, row2.type_operation);
}

                        if(row2.categorie_depense == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, row2.categorie_depense);
}
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"operation");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final J_Load_dim_produit_tx J_Load_dim_produit_txClass = new J_Load_dim_produit_tx();

        int exitCode = J_Load_dim_produit_txClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = J_Load_dim_produit_tx.class.getClassLoader().getResourceAsStream("dwh_attejaribank/j_load_dim_produit_tx_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = J_Load_dim_produit_tx.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : J_Load_dim_produit_tx");
        }
...
/************************************************************************************************
 *     89678 characters generated by Talend Open Studio for Data Integration 
 *     on the 16 avril 2026 à 15:48:56 WAT
 ************************************************************************************************/