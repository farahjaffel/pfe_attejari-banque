...
package dwh_attejaribank.job_load_dim_interaction_0_1;
...
/**
 * Job: Job_Load_DIM_INTERACTION Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Job_Load_DIM_INTERACTION implements TalendJob {
...
public String getSchema_staging(){
	...
	private final String jobName = "Job_Load_DIM_INTERACTION";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Job_Load_DIM_INTERACTION.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Job_Load_DIM_INTERACTION.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class INTERACTIONStruct implements routines.system.IPersistableRow<INTERACTIONStruct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final INTERACTIONStruct other = (INTERACTIONStruct) obj;
	...
	public void copyDataTo(INTERACTIONStruct other) {
	...
	public void copyKeysDataTo(INTERACTIONStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION.length) {
				if(length < 1024 && commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION.length == 0) {
   					commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION = new byte[1024];
				} else {
   					commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION) {
     ...
     * Compare keys
     */
    public int compareTo(INTERACTIONStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_DWH_ATTEJARIBANK_Job_Load_DIM_INTERACTION = new byte[0];
			    ...
			    public Integer est_reclamation;

				public Integer getEst_reclamation () {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.type_interaction = readString(dis);
						...
						this.est_reclamation = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.est_reclamation,dos);
...
INTERACTIONStruct INTERACTION = new INTERACTIONStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"INTERACTION");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DIM_INTERACTION");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DIM_INTERACTION");
}
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("DIM_INTERACTION"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_interaction\" VARCHAR(13)   not null ,\"id_type_intr_pk\" INT4  not null ,\"id_client\" VARCHAR(10)  ,\"date_interaction\" DATE ,\"score_satisfaction_nps\" FLOAT8 ,\"duree_connexion_sec\" INT8 ,\"id_canal_intr\" INT4  not null ,primary key(\"id_interaction\"))");
                                    }
                                }
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_interaction\",\"id_type_intr_pk\",\"id_client\",\"date_interaction\",\"score_satisfaction_nps\",\"duree_connexion_sec\",\"id_canal_intr\") VALUES (?,?,?,?,?,?,?)";
...
INTERACTIONStruct INTERACTION_tmp = new INTERACTIONStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.password; 
            ...
            row1.est_reclamation = rs_tDBInput_1.getInt(6);
            ...
            row1.delai_resolution_jours = rs_tDBInput_1.getDouble(9);
            if(rs_tDBInput_1.wasNull()){
                    row1.delai_resolution_jours = null;
            }
		                    }
            ...
            row1.score_satisfaction_nps = rs_tDBInput_1.getDouble(10);
            if(rs_tDBInput_1.wasNull()){
                    row1.score_satisfaction_nps = null;
            }
		                    }
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.canal_interaction = row1.canal_interaction ;
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.canal_interaction = '" + row2HashKey.canal_interaction + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.type_interaction = row1.type_interaction ;
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.type_interaction = '" + row3HashKey.type_interaction + "'");
								} // G 071
...
// # Output table : 'INTERACTION'
INTERACTION_tmp.id_interaction = row1.id_interaction ;
INTERACTION_tmp.id_type_intr_pk = row3.id_type_intr_sk ;
INTERACTION_tmp.id_client = row1.id_client ;
INTERACTION_tmp.date_interaction = row1.date_interaction ;
INTERACTION_tmp.score_satisfaction_nps = row1.score_satisfaction_nps == null ? 0.0 : row1.score_satisfaction_nps;
INTERACTION_tmp.duree_connexion_sec = row1.duree_connexion_sec ;
INTERACTION_tmp.id_canal_intr = row2.id_canal_intr_sk ;
INTERACTION = INTERACTION_tmp;
// ###############################
...
if(INTERACTION != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(INTERACTION.id_interaction == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, INTERACTION.id_interaction);
}

                    pstmt_tDBOutput_1.setInt(2, INTERACTION.id_type_intr_pk);

                    if(INTERACTION.id_client == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, INTERACTION.id_client);
}

                    if(INTERACTION.date_interaction != null) {
pstmt_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(INTERACTION.date_interaction.getTime()));
} else {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.TIMESTAMP);
}

                    if(INTERACTION.score_satisfaction_nps == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_1.setDouble(5, INTERACTION.score_satisfaction_nps);
}

                    if(INTERACTION.duree_connexion_sec == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setLong(6, INTERACTION.duree_connexion_sec);
}

                    pstmt_tDBOutput_1.setInt(7, INTERACTION.id_canal_intr);
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"INTERACTION");
			  	}
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
    ...
    public String loopKey;
			    ...
			    public int id_canal_intr_sk;

				public int getId_canal_intr_sk () {
					return this.id_canal_intr_sk;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.canal_interaction == null) ? 0 : this.canal_interaction.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row2Struct other = (row2Struct) obj;
						...
						if (this.canal_interaction == null) {
							if (other.canal_interaction != null)
								return false;
						
						} else if (!this.canal_interaction.equals(other.canal_interaction))
	...
	public void copyDataTo(row2Struct other) {
		...
		other.id_canal_intr_sk = this.id_canal_intr_sk;
	            other.canal_interaction = this.canal_interaction;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
			            ...
			            this.id_canal_intr_sk = dis.readInt();
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.id_canal_intr_sk = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
		            	...
		            	dos.writeInt(this.id_canal_intr_sk);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.id_canal_intr_sk);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("id_canal_intr_sk="+String.valueOf(id_canal_intr_sk));
		sb.append(",canal_interaction="+canal_interaction);
	    sb.append("]");
    ...
    public int compareTo(row2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.canal_interaction, other.canal_interaction);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2,row3) outputs:(INTERACTION)
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.password; 
		    ...
		    String dbquery_tDBInput_2 = "SELECT \n  \"DWH_ATTEJARI\".\"DIM_CANAL_INTR\".\"id_canal_intr_sk\", \n  \"DWH_ATTEJARI\".\"DIM_CANAL_INTR\".\"canal_inte"
+"raction\"\nFROM \"DWH_ATTEJARI\".\"DIM_CANAL_INTR\"";
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row2.id_canal_intr_sk = 0;
							} else {
		                          
            row2.id_canal_intr_sk = rs_tDBInput_2.getInt(1);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row2.canal_interaction = null;
							} else {
	                         		
        	row2.canal_interaction = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.id_canal_intr_sk = row2.id_canal_intr_sk;
				
				row2_HashRow.canal_interaction = row2.canal_interaction;
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.type_interaction == null) ? 0 : this.type_interaction.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row3Struct other = (row3Struct) obj;
						...
						if (this.type_interaction == null) {
							if (other.type_interaction != null)
								return false;
						
						} else if (!this.type_interaction.equals(other.type_interaction))
    ...
    public int compareTo(row3Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.type_interaction, other.type_interaction);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = context.password; 
		    ...
		    String dbquery_tDBInput_3 = "SELECT \n  \""+context.schema+"\".\"DIM_TYPE_INTR\".\"id_type_intr_sk\", \n  \""+context.schema+"\".\"DIM_TYPE_INTR\".\"type_interaction\"\nFROM \""+context.schema+"\".\"DIM_TYPE_INTR\"";
		    ...
		    while (rs_tDBInput_3.next()) {
		        nb_line_tDBInput_3++;
							...
							if(colQtyInRs_tDBInput_3 < 1) {
								row3.id_type_intr_sk = 0;
							} else {
		                          
            row3.id_type_intr_sk = rs_tDBInput_3.getInt(1);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row3.type_interaction = null;
							} else {
	                         		
        	row3.type_interaction = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.id_type_intr_sk = row3.id_type_intr_sk;
				
				row3_HashRow.type_interaction = row3.type_interaction;
 ...
 */
    ...
    public static void main(String[] args){
        final Job_Load_DIM_INTERACTION Job_Load_DIM_INTERACTIONClass = new Job_Load_DIM_INTERACTION();

        int exitCode = Job_Load_DIM_INTERACTIONClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Job_Load_DIM_INTERACTION.class.getClassLoader().getResourceAsStream("dwh_attejaribank/job_load_dim_interaction_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Job_Load_DIM_INTERACTION.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Job_Load_DIM_INTERACTION");
        }
...
/************************************************************************************************
 *     141623 characters generated by Talend Open Studio for Data Integration 
 *     on the 16 avril 2026 à 15:49:02 WAT
 ************************************************************************************************/