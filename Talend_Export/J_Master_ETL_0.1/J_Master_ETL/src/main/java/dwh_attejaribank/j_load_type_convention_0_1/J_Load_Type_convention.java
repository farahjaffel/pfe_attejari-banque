...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("DIM_TYPE_CONVENTION"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_type_convention_sk\" SERIAL  not null ,\"type_convention\" VARCHAR(7)  ,primary key(\"type_convention\"))");
                                    }
                                }
...
typeconvention_tmp.id_type_convention_sk = 0;
...
/************************************************************************************************
 *     107161 characters generated by Talend Open Studio for Data Integration 
