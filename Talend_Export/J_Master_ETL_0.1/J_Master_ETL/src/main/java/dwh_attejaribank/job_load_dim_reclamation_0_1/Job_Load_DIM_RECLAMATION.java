...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("DIM_RECLAMATION"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_reclamation_sk\" SERIAL  not null ,\"id_interaction\" VARCHAR(13)   not null ,\"id_motif_recla_fk\" INT4  not null ,\"id_client\" VARCHAR(10)  ,\"est_reclamation\" INT8 ,\"delai_resolution_jours\" FLOAT4 ,\"id_status_recl_fk\" INT4  not null ,primary key(\"id_interaction\"))");
                                    }
                                }
...
reclamation_tmp.id_status_recl_fk = row3.id_status_sk ;
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = context.password; 
		    ...
		    String dbquery_tDBInput_3 = "SELECT \n  \""+context.schema+"\".\"DIM_STATUS_Reclamation\".\"id_status_sk\", \n  \""+context.schema+"\".\"DIM_STATUS_Reclamation\".\"statut_resolution\"\nFROM \""+context.schema+"\".\"DIM_STATUS_Reclamation\"";
            ...
            row3.id_status_sk = rs_tDBInput_3.getInt(1);
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.id_status_sk = row3.id_status_sk;
...
/************************************************************************************************
 *     169678 characters generated by Talend Open Studio for Data Integration 
 *     on the 16 avril 2026 à 15:49:07 WAT
 ************************************************************************************************/