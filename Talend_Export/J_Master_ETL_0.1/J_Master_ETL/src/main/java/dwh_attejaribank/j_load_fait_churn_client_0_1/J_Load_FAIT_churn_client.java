...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("CHURN_CLIENT"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_fact_churn_sk\" SERIAL  not null ,\"id_client\" VARCHAR(10)   not null ,\"id_transaction_pk\" VARCHAR(13)  ,\"id_interaction_pk\" VARCHAR(13)  ,\"id_reclamation_pk\" VARCHAR ,\"id_date_fk\" INT4 ,\"anciennete_mois\" INT8 ,\"score_risque_interne\" INT8 ,\"nb_produits_actifs\" INT8 ,\"revenu_mensuel\" FLOAT8 ,\"solde_moy\" FLOAT8 ,\"monte_mensuel\" FLOAT8 ,\"nb_rejet\" INT8 ,\"nb_transactions\" INT8 ,\"nb_reclamations\" INT8 ,\"nb_interactions\" INT8 ,\"delai_resolution_moyen\" FLOAT8 ,\"duree_inact_connexion_sec\" FLOAT8 ,\"churn\" INT8 ,primary key(\"id_client\",\"id_date_fk\"))");
                                    }
                                }
	...
	currentComponent="tDBInput_9";
		...
		int tos_count_tDBInput_9 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_9 = null;
				...
				String dbUser_tDBInput_9 = context.username;
				
				
	final String decryptedPassword_tDBInput_9 = context.password; 
				
				String dbPwd_tDBInput_9 = decryptedPassword_tDBInput_9;
				
				String url_tDBInput_9 = "jdbc:postgresql://" + context.host + ":" + context.port + "/" + context.database + "?" + context.params;
        	...
        	row1.id_client = routines.system.JDBCUtil.getString(rs_tDBInput_9, 1, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 2) {
								row1.sexe = null;
							} else {
	                         		
        	row1.sexe = routines.system.JDBCUtil.getString(rs_tDBInput_9, 2, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 3) {
								row1.date_naissance = null;
							} else {
										
			row1.date_naissance = routines.system.JDBCUtil.getDate(rs_tDBInput_9, 3);
		                    }
							if(colQtyInRs_tDBInput_9 < 4) {
								row1.est_senior = null;
							} else {
		                          
            row1.est_senior = rs_tDBInput_9.getInt(4);
        	...
        	row1.situation_matrimoniale = routines.system.JDBCUtil.getString(rs_tDBInput_9, 5, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 6) {
								row1.enfants_a_charge = null;
							} else {
		                          
            row1.enfants_a_charge = rs_tDBInput_9.getInt(6);
            if(rs_tDBInput_9.wasNull()){
                    row1.enfants_a_charge = null;
            }
		                    }
        	...
        	row1.profession = routines.system.JDBCUtil.getString(rs_tDBInput_9, 7, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 8) {
								row1.ville_region = null;
							} else {
	                         		
        	row1.ville_region = routines.system.JDBCUtil.getString(rs_tDBInput_9, 8, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 9) {
								row1.anciennete_mois = null;
							} else {
		                          
            row1.anciennete_mois = rs_tDBInput_9.getLong(9);
            if(rs_tDBInput_9.wasNull()){
                    row1.anciennete_mois = null;
            }
		                    }
            ...
            row1.service_sms_banking = rs_tDBInput_9.getInt(10);
            if(rs_tDBInput_9.wasNull()){
                    row1.service_sms_banking = null;
            }
		                    }
        	...
        	row1.acces_banque_en_ligne = routines.system.JDBCUtil.getString(rs_tDBInput_9, 11, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 12) {
								row1.alerte_securite_active = null;
							} else {
		                          
            row1.alerte_securite_active = rs_tDBInput_9.getInt(12);
            if(rs_tDBInput_9.wasNull()){
                    row1.alerte_securite_active = null;
            }
		                    }
            ...
            row1.assurance_moyen_paiement = rs_tDBInput_9.getInt(13);
            if(rs_tDBInput_9.wasNull()){
                    row1.assurance_moyen_paiement = null;
            }
		                    }
            ...
            row1.conseiller_dedie = rs_tDBInput_9.getInt(14);
            if(rs_tDBInput_9.wasNull()){
                    row1.conseiller_dedie = null;
            }
		                    }
            ...
            row1.programme_fidelite = rs_tDBInput_9.getInt(15);
            if(rs_tDBInput_9.wasNull()){
                    row1.programme_fidelite = null;
            }
		                    }
        	...
        	row1.type_convention = routines.system.JDBCUtil.getString(rs_tDBInput_9, 16, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 17) {
								row1.e_releve_active = null;
							} else {
		                          
            row1.e_releve_active = rs_tDBInput_9.getInt(17);
            if(rs_tDBInput_9.wasNull()){
                    row1.e_releve_active = null;
            }
		                    }
        	...
        	row1.methode_paiement_fav = routines.system.JDBCUtil.getString(rs_tDBInput_9, 18, false);
		                    }
							if(colQtyInRs_tDBInput_9 < 19) {
								row1.frais_bancaires_mensuels = null;
							} else {
	                         		
            row1.frais_bancaires_mensuels = rs_tDBInput_9.getDouble(19);
            if(rs_tDBInput_9.wasNull()){
                    row1.frais_bancaires_mensuels = null;
            }
		                    }
            ...
            row1.total_frais_cumules = rs_tDBInput_9.getDouble(20);
            if(rs_tDBInput_9.wasNull()){
                    row1.total_frais_cumules = null;
            }
		                    }
            ...
            row1.revenu_mensuel = rs_tDBInput_9.getDouble(21);
            if(rs_tDBInput_9.wasNull()){
                    row1.revenu_mensuel = null;
            }
		                    }
            ...
            row1.nb_produits_actifs = rs_tDBInput_9.getLong(22);
            if(rs_tDBInput_9.wasNull()){
                    row1.nb_produits_actifs = null;
            }
		                    }
            ...
            row1.score_risque_interne = rs_tDBInput_9.getLong(23);
            if(rs_tDBInput_9.wasNull()){
                    row1.score_risque_interne = null;
            }
		                    }
            ...
            row1.churn = rs_tDBInput_9.getLong(24);
            if(rs_tDBInput_9.wasNull()){
                    row1.churn = null;
            }
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// source node:tDBInput_3 - inputs:(after_tDBInput_9) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row4,row8,row9,row5,row3,row7,row10) outputs:(fact)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row8";
		...
		int tos_count_tAdvancedHash_row8 = 0;
			   		...
			   		// source node:tDBInput_5 - inputs:(after_tDBInput_9) outputs:(row8,row8) | target node:tAdvancedHash_row8 - inputs:(row8) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row4,row8,row9,row5,row3,row7,row10) outputs:(fact)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row9";
		...
		int tos_count_tAdvancedHash_row9 = 0;
			   		...
			   		// source node:tDBInput_6 - inputs:(after_tDBInput_9) outputs:(row9,row9) | target node:tAdvancedHash_row9 - inputs:(row9) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row4,row8,row9,row5,row3,row7,row10) outputs:(fact)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// source node:tDBInput_2 - inputs:(after_tDBInput_9) outputs:(row5,row5) | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row4,row8,row9,row5,row3,row7,row10) outputs:(fact)
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.password; 
		    ...
		    String dbquery_tDBInput_2 = "SELECT \n  \""+context.schema+"\".\"DIM_DATE\".\"id_date_sk\", \n  \""+context.schema+"\".\"DIM_DATE\".\"date_complete\", \n  \""+context.schema+"\".\"DIM_DATE\".\"annee\", \n  \""+context.schema+"\".\"DIM_DATE\".\"mois\", \n  \""+context.schema+"\".\"DIM_DATE\".\"nom_mois\", \n  \""+context.schema+"\".\"DIM_DATE\".\"jour\", \n  \""+context.schema+"\".\"DIM_DATE\".\"jour_semaine\", \n  \""+context.schema+"\".\"DIM_DATE\".\"nom_jour\", \n  \""+context.schema+"\".\"DIM_DATE\".\"trimestre\", \n  \""+context.schema+"\".\"DIM_DATE\".\"est_weekend\"\nFROM \""+context.schema+"\".\"DIM_DATE\"";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  \""+context.schema_staging+"\".\"stg_transactions\".\"id_transaction\", \n  \""+context.schema_staging+"\".\"stg_transactions\".\"id_client\", \n  \""+context.schema_staging+"\".\"stg_transactions\".\"date_transaction\", \n  \""+context.schema_staging+"\".\"stg_transactions\".\"type_operation\", \n  \""+context.schema_staging+"\".\"stg_transactions\".\"montant\", \n  \""+context.schema_staging+"\".\"stg_transactions\".\"sens_operation\", \n  \""+context.schema_staging+"\".\"stg_transactions\".\"canal_transaction\", \n  \""+context.schema_staging+"\".\"stg_transactions\".\"solde_apres_operation\", \n  \""+context.schema_staging+"\".\"stg_transactions\".\"est_rejete\", \n  \""+context.schema_staging+"\".\"stg_transactions\".\"categorie_depense\"\nFROM \""+context.schema_staging+"\".\"stg_transactions\"";
        	...
        	row2.id_transaction = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row2.id_client = null;
							} else {
	                         		
        	row2.id_client = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row2.date_transaction = null;
							} else {
										
			row2.date_transaction = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 3);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row2.type_operation = null;
							} else {
	                         		
        	row2.type_operation = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row2.montant = null;
							} else {
	                         		
            row2.montant = rs_tDBInput_1.getDouble(5);
        	...
        	row2.sens_operation = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row2.canal_transaction = null;
							} else {
	                         		
        	row2.canal_transaction = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row2.solde_apres_operation = null;
							} else {
	                         		
            row2.solde_apres_operation = rs_tDBInput_1.getDouble(8);
            if(rs_tDBInput_1.wasNull()){
                    row2.solde_apres_operation = null;
            }
		                    }
            ...
            row2.est_rejete = rs_tDBInput_1.getLong(9);
            if(rs_tDBInput_1.wasNull()){
                    row2.est_rejete = null;
            }
		                    }
        	...
        	row2.categorie_depense = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row2.nb_transactions = null;
							} else {
		                          
            row2.nb_transactions = rs_tDBInput_1.getLong(11);
            if(rs_tDBInput_1.wasNull()){
                    row2.nb_transactions = null;
            }
		                    }
            ...
            row2.solde_moy = rs_tDBInput_1.getDouble(12);
            if(rs_tDBInput_1.wasNull()){
                    row2.solde_moy = null;
            }
		                    }
            ...
            row2.nb_rejet = rs_tDBInput_1.getLong(13);
            if(rs_tDBInput_1.wasNull()){
                    row2.nb_rejet = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row2.monte_mensuel = null;
							} else {
	                         		
            row2.monte_mensuel = rs_tDBInput_1.getDouble(14);
            if(rs_tDBInput_1.wasNull()){
                    row2.monte_mensuel = null;
            }
		                    }
...
public static class row7Struct implements routines.system.IPersistableComparableLookupRow<row7Struct> {
    ...
    public String loopKey;
			    ...
			    public int id_type_intr_pk;

				public int getId_type_intr_pk () {
					return this.id_type_intr_pk;
				}
	...
	public void copyDataTo(row7Struct other) {
		...
		other.id_interaction = this.id_interaction;
	            other.id_type_intr_pk = this.id_type_intr_pk;
	            other.id_client = this.id_client;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
			            ...
			            this.id_type_intr_pk = dis.readInt();
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.id_type_intr_pk = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
		            	...
		            	dos.writeInt(this.id_type_intr_pk);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.id_type_intr_pk);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("id_interaction="+id_interaction);
		sb.append(",id_type_intr_pk="+String.valueOf(id_type_intr_pk));
		sb.append(",id_client="+id_client);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// source node:tDBInput_4 - inputs:(after_tDBInput_9) outputs:(row7,row7) | target node:tAdvancedHash_row7 - inputs:(row7) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row4,row8,row9,row5,row3,row7,row10) outputs:(fact)
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = context.password; 
		    ...
		    String dbquery_tDBInput_4 = "SELECT \n  \""+context.schema+"\".\"DIM_INTERACTION\".\"id_interaction\", \n  \""+context.schema+"\".\"DIM_INTERACTION\".\"id_type_intr_pk\", \n  \""+context.schema+"\".\"DIM_INTERACTION\".\"id_client\", \n  \""+context.schema+"\".\"DIM_INTERACTION\".\"date_interaction\", \n  \""+context.schema+"\".\"DIM_INTERACTION\".\"score_satisfaction_nps\", \n  \""+context.schema+"\".\"DIM_INTERACTION\".\"duree_connexion_sec\", \n  \""+context.schema+"\".\"DIM_INTERACTION\".\"id_canal_intr\"\nFROM \""+context.schema+"\".\"DIM_INTERACTION\"";
        	...
        	row7.id_interaction = routines.system.JDBCUtil.getString(rs_tDBInput_4, 1, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 2) {
								row7.id_type_intr_pk = 0;
							} else {
		                          
            row7.id_type_intr_pk = rs_tDBInput_4.getInt(2);
            ...
            row7.score_satisfaction_nps = rs_tDBInput_4.getDouble(5);
            if(rs_tDBInput_4.wasNull()){
                    row7.score_satisfaction_nps = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
				...
				row7_HashRow.id_type_intr_pk = row7.id_type_intr_pk;
...
public static class intrStruct implements routines.system.IPersistableRow<intrStruct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_FAIT_churn_client = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load_FAIT_churn_client = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final intrStruct other = (intrStruct) obj;
	...
	public void copyDataTo(intrStruct other) {
	...
	public void copyKeysDataTo(intrStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(intrStruct other) {
...
intrStruct intr = new intrStruct();
row10Struct row10 = new row10Struct();
	...
	currentComponent="tAggregateRow_2_AGGOUT";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"intr");
					}
...
// ###############################
// # Outputs initialization
intrStruct intr_tmp = new intrStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_7 = context.password; 
		    ...
		    String dbquery_tDBInput_7 = "SELECT \n  \""+context.schema_staging+"\".\"stg_interactions\".\"id_interaction\", \n  \""+context.schema_staging+"\".\"stg_interactions\".\"id_client\", \n  \""+context.schema_staging+"\".\"stg_interactions\".\"date_interaction\", \n  \""+context.schema_staging+"\".\"stg_interactions\".\"canal_interaction\", \n  \""+context.schema_staging+"\".\"stg_interactions\".\"type_interaction\", \n  \""+context.schema_staging+"\".\"stg_interactions\".\"est_reclamation\", \n  \""+context.schema_staging+"\".\"stg_interactions\".\"motif_reclamation\", \n  \""+context.schema_staging+"\".\"stg_interactions\".\"statut_resolution\", \n  \""+context.schema_staging+"\".\"stg_interactions\".\"delai_resolution_jours\", \n  \""+context.schema_staging+"\".\"stg_interactions\".\"score_satisfaction_nps\", \n  \""+context.schema_staging+"\".\"stg_interactions\".\"duree_connexion_sec\"\nFROM \""+context.schema_staging+"\".\"stg_interactions\"";
        	...
        	row6.id_interaction = routines.system.JDBCUtil.getString(rs_tDBInput_7, 1, false);
		                    }
							if(colQtyInRs_tDBInput_7 < 2) {
								row6.id_client = null;
							} else {
	                         		
        	row6.id_client = routines.system.JDBCUtil.getString(rs_tDBInput_7, 2, false);
		                    }
							if(colQtyInRs_tDBInput_7 < 3) {
								row6.date_interaction = null;
							} else {
										
			row6.date_interaction = routines.system.JDBCUtil.getDate(rs_tDBInput_7, 3);
		                    }
							if(colQtyInRs_tDBInput_7 < 4) {
								row6.canal_interaction = null;
							} else {
	                         		
        	row6.canal_interaction = routines.system.JDBCUtil.getString(rs_tDBInput_7, 4, false);
		                    }
							if(colQtyInRs_tDBInput_7 < 5) {
								row6.type_interaction = null;
							} else {
	                         		
        	row6.type_interaction = routines.system.JDBCUtil.getString(rs_tDBInput_7, 5, false);
		                    }
							if(colQtyInRs_tDBInput_7 < 6) {
								row6.est_reclamation = null;
							} else {
		                          
            row6.est_reclamation = rs_tDBInput_7.getLong(6);
        	...
        	row6.motif_reclamation = routines.system.JDBCUtil.getString(rs_tDBInput_7, 7, false);
		                    }
							if(colQtyInRs_tDBInput_7 < 8) {
								row6.statut_resolution = null;
							} else {
	                         		
        	row6.statut_resolution = routines.system.JDBCUtil.getString(rs_tDBInput_7, 8, false);
		                    }
							if(colQtyInRs_tDBInput_7 < 9) {
								row6.delai_resolution_jours = null;
							} else {
	                         		
            row6.delai_resolution_jours = rs_tDBInput_7.getDouble(9);
            if(rs_tDBInput_7.wasNull()){
                    row6.delai_resolution_jours = null;
            }
		                    }
            ...
            row6.score_satisfaction_nps = rs_tDBInput_7.getDouble(10);
            if(rs_tDBInput_7.wasNull()){
                    row6.score_satisfaction_nps = null;
            }
		                    }
            ...
            row6.duree_connexion_sec = rs_tDBInput_7.getLong(11);
            if(rs_tDBInput_7.wasNull()){
                    row6.duree_connexion_sec = null;
            }
		                    }
...
// # Output table : 'intr'
intr_tmp.id_interaction = row6.id_interaction ;
intr_tmp.id_client = row6.id_client ;
intr_tmp.date_interaction = row6.date_interaction ;
intr_tmp.canal_interaction = row6.canal_interaction ;
intr_tmp.type_interaction = row6.type_interaction ;
intr_tmp.est_reclamation = row6.est_reclamation == null ? 0L : row6.est_reclamation;
intr_tmp.motif_reclamation = row6.motif_reclamation ;
intr_tmp.statut_resolution = row6.statut_resolution ;
intr_tmp.delai_resolution_jours = row6.delai_resolution_jours == null ? 0.0 : row6.delai_resolution_jours;
intr_tmp.score_satisfaction_nps = row6.score_satisfaction_nps == null ? 0.0 : row6.score_satisfaction_nps;
intr_tmp.duree_connexion_sec = row6.duree_connexion_sec == null ? 0L : row6.duree_connexion_sec;
intr_tmp.nb_reclamations = null;
intr_tmp.nb_interactions = null;
intr_tmp.delai_resolution_moyen = null;
intr_tmp.duree_inact_connexion_sec = null;
intr = intr_tmp;
// ###############################
...
operation_finder_tAggregateRow_2.id_client = intr.id_client;
	...
	if(operation_result_tAggregateRow_2 == null) { // G_OutMain_AggR_001
		...
		hash_tAggregateRow_2.put(operation_result_tAggregateRow_2, operation_result_tAggregateRow_2);
				...
				operation_result_tAggregateRow_2.count++;
					...
					if( intr.est_reclamation != null)
						operation_result_tAggregateRow_2.nb_reclamations_sum += intr.est_reclamation;
				...
				operation_result_tAggregateRow_2.duree_inact_connexion_sec_count++;
					...
					if( intr.duree_connexion_sec != null)
						operation_result_tAggregateRow_2.duree_inact_connexion_sec_sum += intr.duree_connexion_sec;
 ...
 */
	...
	currentComponent="tAggregateRow_2_AGGOUT";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"intr");
			  	}
...
/************************************************************************************************
 *     535375 characters generated by Talend Open Studio for Data Integration 
 *     on the 16 avril 2026 à 15:49:09 WAT
 ************************************************************************************************/