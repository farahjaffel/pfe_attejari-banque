...
package dwh_attejaribank.j_load_dim_canal_0_1;
...
/**
 * Job: J_Load_Dim_Canal Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class J_Load_Dim_Canal implements TalendJob {
...
public String getSchema_staging(){
	...
	private final String jobName = "J_Load_Dim_Canal";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				J_Load_Dim_Canal.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(J_Load_Dim_Canal.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_Dim_Canal = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load_Dim_Canal = new byte[0];
    ...
    public String loopKey;
			    ...
			    public int id_canal_tx_sk;

				public int getId_canal_tx_sk () {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DWH_ATTEJARIBANK_J_Load_Dim_Canal.length) {
				if(length < 1024 && commonByteArray_DWH_ATTEJARIBANK_J_Load_Dim_Canal.length == 0) {
   					commonByteArray_DWH_ATTEJARIBANK_J_Load_Dim_Canal = new byte[1024];
				} else {
   					commonByteArray_DWH_ATTEJARIBANK_J_Load_Dim_Canal = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DWH_ATTEJARIBANK_J_Load_Dim_Canal, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_J_Load_Dim_Canal, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DWH_ATTEJARIBANK_J_Load_Dim_Canal, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_J_Load_Dim_Canal, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_Dim_Canal) {

        	try {

        		int length = 0;
		
			        this.id_canal_tx_sk = dis.readInt();
					
					this.canal_transaction = readString(dis);
					
					this.libelle_cana = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.id_canal_tx_sk);
					...
					// String
						...
						writeString(this.libelle_cana,dos);
...
public static class canal_txStruct implements routines.system.IPersistableRow<canal_txStruct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_Dim_Canal = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load_Dim_Canal = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final canal_txStruct other = (canal_txStruct) obj;
	...
	public void copyDataTo(canal_txStruct other) {
	...
	public void copyKeysDataTo(canal_txStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(canal_txStruct other) {
...
canal_txStruct canal_tx = new canal_txStruct();
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DIM_CANAL_TX");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DIM_CANAL_TX");
}
...
String dbUser_tDBOutput_1 = null;
    ...
    java.lang.Class.forName("org.postgresql.Driver");
        ...
        String url_tDBOutput_1 = "jdbc:postgresql://"+context.host+":"+context.port+"/"+context.database;
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("DIM_CANAL_TX"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_canal_tx_sk\" SERIAL  not null ,\"canal_transaction\" VARCHAR(50)  ,\"libelle_cana\" VARCHAR ,primary key(\"canal_transaction\"))");
                                    }
                                }
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"canal_transaction\" = ?,\"libelle_cana\" = ? WHERE \"canal_transaction\" = ?";
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"canal_transaction\",\"libelle_cana\") VALUES (?,?)";
 ...
 */
	...
	currentComponent="tUniqRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"canal_tx");
					}
		...
		class KeyStruct_tUniqRow_1 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.libelle_cana == null) ? 0 : this.libelle_cana.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									if (this.libelle_cana == null) {
										if (other.libelle_cana != null) 
											return false;
								
									} else if (!this.libelle_cana.equals(other.libelle_cana))
...
canal_txStruct canal_tx_tmp = new canal_txStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.password; 
            ...
            row1.est_rejete = rs_tDBInput_1.getInt(9);
            if(rs_tDBInput_1.wasNull()){
                    row1.est_rejete = null;
            }
		                    }
...
// # Output table : 'canal_tx'
canal_tx_tmp.id_canal_tx_sk = 0;
canal_tx_tmp.canal_transaction = row1.canal_transaction ;
canal_tx_tmp.libelle_cana = row1.canal_transaction.equals("Agence") ? "Transaction en agence physique" :
row1.canal_transaction.equals("DAB") ? "Distributeur automatique de billets" :
row1.canal_transaction.equals("TPE") ? "Terminal de paiement electronique" :
row1.canal_transaction.equals("En Ligne") ? "Transaction via internet ou application" :
"" ;
canal_tx = canal_tx_tmp;
// ###############################
...
row2 = null;			
if(canal_tx.canal_transaction == null){
	finder_tUniqRow_1.canal_transaction = null;
}else{
	finder_tUniqRow_1.canal_transaction = canal_tx.canal_transaction.toLowerCase();
}
if(canal_tx.libelle_cana == null){
	finder_tUniqRow_1.libelle_cana = null;
}else{
	finder_tUniqRow_1.libelle_cana = canal_tx.libelle_cana.toLowerCase();
}	
...
if(canal_tx.canal_transaction == null){
	new_tUniqRow_1.canal_transaction = null;
}else{
	new_tUniqRow_1.canal_transaction = canal_tx.canal_transaction.toLowerCase();
}
if(canal_tx.libelle_cana == null){
	new_tUniqRow_1.libelle_cana = null;
}else{
	new_tUniqRow_1.libelle_cana = canal_tx.libelle_cana.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.id_canal_tx_sk = canal_tx.id_canal_tx_sk;			row2.canal_transaction = canal_tx.canal_transaction;			row2.libelle_cana = canal_tx.libelle_cana;					
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
            int updateFlag_tDBOutput_1=0;
                    if(row2.canal_transaction == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, row2.canal_transaction);
}

                    if(row2.libelle_cana == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, row2.libelle_cana);
}


                    if(row2.canal_transaction == null) {
pstmtUpdate_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, row2.canal_transaction);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, row2.canal_transaction);
}

                        if(row2.libelle_cana == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, row2.libelle_cana);
}
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"canal_tx");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final J_Load_Dim_Canal J_Load_Dim_CanalClass = new J_Load_Dim_Canal();

        int exitCode = J_Load_Dim_CanalClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = J_Load_Dim_Canal.class.getClassLoader().getResourceAsStream("dwh_attejaribank/j_load_dim_canal_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = J_Load_Dim_Canal.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : J_Load_Dim_Canal");
        }
...
/************************************************************************************************
 *     86932 characters generated by Talend Open Studio for Data Integration 
 *     on the 16 avril 2026 à 15:48:50 WAT
 ************************************************************************************************/