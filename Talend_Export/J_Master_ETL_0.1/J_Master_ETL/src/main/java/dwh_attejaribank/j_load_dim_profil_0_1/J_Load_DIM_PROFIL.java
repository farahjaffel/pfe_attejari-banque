...
package dwh_attejaribank.j_load_dim_profil_0_1;
...
/**
 * Job: J_Load_DIM_PROFIL Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class J_Load_DIM_PROFIL implements TalendJob {
...
public String getSchema_staging(){
	...
	private final String jobName = "J_Load_DIM_PROFIL";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				J_Load_DIM_PROFIL.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(J_Load_DIM_PROFIL.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL = new byte[0];
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL.length) {
				if(length < 1024 && commonByteArray_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL.length == 0) {
   					commonByteArray_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL = new byte[1024];
				} else {
   					commonByteArray_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL, 0, length);
			strReturn = new String(commonByteArray_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_DWH_ATTEJARIBANK_J_Load_DIM_PROFIL = new byte[0];
			    ...
			    public BigDecimal frais_bancaires_mensuels;

				public BigDecimal getFrais_bancaires_mensuels () {
					return this.frais_bancaires_mensuels;
				}
				
			    public BigDecimal total_frais_cumules;

				public BigDecimal getTotal_frais_cumules () {
					return this.total_frais_cumules;
				}
				
			    public BigDecimal revenu_mensuel;
			    ...
			    public BigDecimal score_risque_interne;

				public BigDecimal getScore_risque_interne () {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.methode_paiement_fav = readString(dis);
						...
						this.frais_bancaires_mensuels = (BigDecimal) dis.readObject();
					
						this.total_frais_cumules = (BigDecimal) dis.readObject();
					
						this.revenu_mensuel = (BigDecimal) dis.readObject();
					
						this.nb_produits_actifs = readInteger(dis);
					
						this.score_risque_interne = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.frais_bancaires_mensuels);
					
					// BigDecimal
				
       			    	dos.writeObject(this.total_frais_cumules);
					
					// BigDecimal
				
       			    	dos.writeObject(this.revenu_mensuel);
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.score_risque_interne);
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("DIM_PROFIL");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("DIM_PROFIL");
}
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("DIM_PROFIL"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"id_profil_sk\" SERIAL  not null ,\"id_client\" VARCHAR(10)   not null ,\"situation_matrimoniale\" VARCHAR(11)  ,\"enfants_a_charge\" INT8 ,\"profession\" VARCHAR(17)  ,\"ville_region\" VARCHAR(11)  ,\"est_senior\" INT8 ,primary key(\"id_client\"))");
                                    }
                                }
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"id_client\" = ?,\"situation_matrimoniale\" = ?,\"enfants_a_charge\" = ?,\"profession\" = ?,\"ville_region\" = ?,\"est_senior\" = ? WHERE \"id_client\" = ?";
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_client\",\"situation_matrimoniale\",\"enfants_a_charge\",\"profession\",\"ville_region\",\"est_senior\") VALUES (?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.password; 
        	...
        	row1.id_client = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row1.sexe = null;
							} else {
	                         		
        	row1.sexe = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row1.date_naissance = null;
							} else {
										
			row1.date_naissance = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 3);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row1.est_senior = null;
							} else {
		                          
            row1.est_senior = rs_tDBInput_2.getLong(4);
        	...
        	row1.situation_matrimoniale = routines.system.JDBCUtil.getString(rs_tDBInput_2, 5, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 6) {
								row1.enfants_a_charge = null;
							} else {
		                          
            row1.enfants_a_charge = rs_tDBInput_2.getLong(6);
            if(rs_tDBInput_2.wasNull()){
                    row1.enfants_a_charge = null;
            }
		                    }
        	...
        	row1.profession = routines.system.JDBCUtil.getString(rs_tDBInput_2, 7, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 8) {
								row1.ville_region = null;
							} else {
	                         		
        	row1.ville_region = routines.system.JDBCUtil.getString(rs_tDBInput_2, 8, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 9) {
								row1.anciennete_mois = null;
							} else {
		                          
            row1.anciennete_mois = rs_tDBInput_2.getInt(9);
            if(rs_tDBInput_2.wasNull()){
                    row1.anciennete_mois = null;
            }
		                    }
            ...
            row1.service_sms_banking = rs_tDBInput_2.getInt(10);
            if(rs_tDBInput_2.wasNull()){
                    row1.service_sms_banking = null;
            }
		                    }
        	...
        	row1.acces_banque_en_ligne = routines.system.JDBCUtil.getString(rs_tDBInput_2, 11, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 12) {
								row1.alerte_securite_active = null;
							} else {
		                          
            row1.alerte_securite_active = rs_tDBInput_2.getInt(12);
            if(rs_tDBInput_2.wasNull()){
                    row1.alerte_securite_active = null;
            }
		                    }
            ...
            row1.assurance_moyen_paiement = rs_tDBInput_2.getInt(13);
            if(rs_tDBInput_2.wasNull()){
                    row1.assurance_moyen_paiement = null;
            }
		                    }
            ...
            row1.conseiller_dedie = rs_tDBInput_2.getInt(14);
            if(rs_tDBInput_2.wasNull()){
                    row1.conseiller_dedie = null;
            }
		                    }
            ...
            row1.programme_fidelite = rs_tDBInput_2.getInt(15);
            if(rs_tDBInput_2.wasNull()){
                    row1.programme_fidelite = null;
            }
		                    }
        	...
        	row1.type_convention = routines.system.JDBCUtil.getString(rs_tDBInput_2, 16, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 17) {
								row1.e_releve_active = null;
							} else {
		                          
            row1.e_releve_active = rs_tDBInput_2.getInt(17);
            if(rs_tDBInput_2.wasNull()){
                    row1.e_releve_active = null;
            }
		                    }
        	...
        	row1.methode_paiement_fav = routines.system.JDBCUtil.getString(rs_tDBInput_2, 18, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 19) {
								row1.frais_bancaires_mensuels = null;
							} else {
		                          
            row1.frais_bancaires_mensuels = rs_tDBInput_2.getBigDecimal(19);
            if(rs_tDBInput_2.wasNull()){
                    row1.frais_bancaires_mensuels = null;
            }
		                    }
            ...
            row1.total_frais_cumules = rs_tDBInput_2.getBigDecimal(20);
            if(rs_tDBInput_2.wasNull()){
                    row1.total_frais_cumules = null;
            }
		                    }
            ...
            row1.revenu_mensuel = rs_tDBInput_2.getBigDecimal(21);
            if(rs_tDBInput_2.wasNull()){
                    row1.revenu_mensuel = null;
            }
		                    }
            ...
            row1.nb_produits_actifs = rs_tDBInput_2.getInt(22);
            if(rs_tDBInput_2.wasNull()){
                    row1.nb_produits_actifs = null;
            }
		                    }
            ...
            row1.score_risque_interne = rs_tDBInput_2.getBigDecimal(23);
            if(rs_tDBInput_2.wasNull()){
                    row1.score_risque_interne = null;
            }
		                    }
            ...
            row1.churn = rs_tDBInput_2.getInt(24);
            if(rs_tDBInput_2.wasNull()){
                    row1.churn = null;
            }
		                    }
...
// # Output table : 'row2'
row2_tmp.id_profil_sk = Numeric.sequence("seq_profil", 1, 1);
row2_tmp.id_client = row1.id_client ;
row2_tmp.situation_matrimoniale = row1.situation_matrimoniale ;
row2_tmp.enfants_a_charge = row1.enfants_a_charge ;
row2_tmp.profession = row1.profession ;
row2_tmp.ville_region = row1.ville_region ;
row2_tmp.est_senior = row1.est_senior ;
row2 = row2_tmp;
// ###############################
...
} else {pstmtUpdate_tDBOutput_1.setString(1, row2.id_client);
}

                    if(row2.situation_matrimoniale == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, row2.situation_matrimoniale);
}

                    if(row2.enfants_a_charge == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setLong(3, row2.enfants_a_charge);
}

                    if(row2.profession == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, row2.profession);
}

                    if(row2.ville_region == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5, row2.ville_region);
}

                    if(row2.est_senior == null) {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setLong(6, row2.est_senior);
}


                    if(row2.id_client == null) {
pstmtUpdate_tDBOutput_1.setNull(7 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(7 + count_tDBOutput_1, row2.id_client);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, row2.id_client);
}

                        if(row2.situation_matrimoniale == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, row2.situation_matrimoniale);
}

                        if(row2.enfants_a_charge == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setLong(3, row2.enfants_a_charge);
}

                        if(row2.profession == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, row2.profession);
}

                        if(row2.ville_region == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, row2.ville_region);
}

                        if(row2.est_senior == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setLong(6, row2.est_senior);
}
 ...
 */
    ...
    public static void main(String[] args){
        final J_Load_DIM_PROFIL J_Load_DIM_PROFILClass = new J_Load_DIM_PROFIL();

        int exitCode = J_Load_DIM_PROFILClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = J_Load_DIM_PROFIL.class.getClassLoader().getResourceAsStream("dwh_attejaribank/j_load_dim_profil_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = J_Load_DIM_PROFIL.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : J_Load_DIM_PROFIL");
        }
...
/************************************************************************************************
 *     91525 characters generated by Talend Open Studio for Data Integration 
 *     on the 16 avril 2026 à 15:48:54 WAT
 ************************************************************************************************/